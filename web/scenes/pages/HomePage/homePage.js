...
import { star, bookFull } from '~/utils/svgImages'
...
export const HomePage = () => {
  return (
    <>
      ...
      <section className={`reviews pt-9x ${styles.reviews}`}>
        <div className="container">
